var UiTextureEditor = IgeEventingClass.extend({
	...
	init: function () {
		var self = this;
		ige.requireStylesheet(igeRoot + 'components/editor/ui/insert/insert.css');
	...
	ready: function () {
		...
		ige.editor.ui.menus.addMenuGroup('insertMenu', 'objects');
		ige.editor.ui.menus.addMenuItem('insertMenu', 'objects', {
			id: 'insertDialog',
			icon: 'none',
			text: 'Insert Object...',
